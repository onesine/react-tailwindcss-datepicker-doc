...
const Props = () => {
    ...
    const [singleDate, setSingleDate] = useState(defaultValue);
                ...
                <Indent>
                    ...
                    <Indent>
                        <Indent>
                            ...
                            <Indent>
                                <Indent>
                                    <Keyword>inputClassName</Keyword><LightBlue>={"\""}</LightBlue>w-full rounded-md focus:ring-0 font-normal bg-green-100 dark:bg-green-900 dark:placeholder:text-green-100<LightBlue>{"\""}</LightBlue> <br/>
                                    <Keyword>value</Keyword><LightBlue>={"{"}</LightBlue>value<LightBlue>{"}"}</LightBlue> <br/>
                                    <Keyword>onChange</Keyword><LightBlue>={"{"}</LightBlue>handleValueChange<LightBlue>{"}"}</LightBlue> <br/>
                                </Indent>
                            </Indent>
                ...
                <Indent>
                    ...
                    <Indent>
                        <Indent>
                            ...
                            <Indent>
                                <Indent>
                                    <Keyword>containerClassName</Keyword><LightBlue>={"\""}</LightBlue>relative mt-8<LightBlue>{"\""}</LightBlue> <br/>
                                    <Keyword>value</Keyword><LightBlue>={"{"}</LightBlue>value<LightBlue>{"}"}</LightBlue> <br/>
                                    <Keyword>onChange</Keyword><LightBlue>={"{"}</LightBlue>handleValueChange<LightBlue>{"}"}</LightBlue> <br/>
                                </Indent>
                            </Indent>
                ...
                <Indent>
                    ...
                    <Indent>
                        <Indent>
                            ...
                            <Indent>
                                <Indent>
                                    <Keyword>toggleClassName</Keyword><LightBlue>={"\""}</LightBlue>absolute bg-blue-300 rounded-r-lg text-white right-0 h-full px-3 text-gray-400 focus:outline-none disabled:opacity-40 disabled:cursor-not-allowed<LightBlue>{"\""}</LightBlue> <br/>
                                    <Keyword>value</Keyword><LightBlue>={"{"}</LightBlue>value<LightBlue>{"}"}</LightBlue> <br/>
                                    <Keyword>onChange</Keyword><LightBlue>={"{"}</LightBlue>handleValueChange<LightBlue>{"}"}</LightBlue> <br/>
                                </Indent>
                            </Indent>
