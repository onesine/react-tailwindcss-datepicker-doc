    ...
    return (
        <div className="grid grid-cols-3 gap-6 md:gap-3 lg:gap-6">
            {features.map((item, index) => (
                <div key={index} className="col-span-3 md:col-span-1 bg-gray-100/70 rounded-lg p-6 dark:bg-white/10">
                    <div className="h-12 w-12 bg-gray-200 rounded-md flex items-center justify-center text-xl dark:bg-slate-800">{item.emoji}</div>
