...
export const NavLink = ({children, href, position = "text-end", page = "Next"}) => (
    <Link href={href} className={`hover:transition hover:duration-300 py-2 px-4 ${position} w-1/2 border dark:border-slate-700 hover:border-sky-500 dark:hover:border-sky-500 rounded-md`}>
