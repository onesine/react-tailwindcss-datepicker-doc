            ...
            <Link href="/" className={`relative group ${router.pathname !== "/" ? "focus:outline-none" : ""}`}>
                ...
                <div className="flex item-center space-x-3">
                    ...
                    <div className="hidden md:block">
                        <span className="text-xs bg-gray-100 dark:text-white/50 dark:bg-slate-600 dark:border-slate-500 font-semibold text-gray-500 border rounded-full px-2 py-0.5">1.4.0</span>
                    </div>
                </div>
            </Link>
